                    ...
                    columnDefs: [
                        ...
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="admin/company/`+ full.id +`/ad"><i class="fas fa-audio-description"></i>عرض  إعلانات الشركة</a>
                                <a class="dropdown-item" href="admin/company/`+ full.id +`"><i class="far fa-building"></i> عرض  بيانات الشركة</a>
                                <a class="dropdown-item" href="admin/company/`+ full.id +`/edit"><i class="la la-edit"></i> تعديل بيانات الشركة</a>
                                <a class="dropdown-item delete"  href="javascript:;" ><i class="la la-leaf"></i> حذف الشركة </a>
                            </div>
                        </span>`;
                            },
                        },
