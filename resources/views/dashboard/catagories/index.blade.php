                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('catagory.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                    ...
                    columnDefs: [
                        ...
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="admin/catagory/`+ full.id +`/edit"><i class="la la-edit"></i> تعديل التصنيف</a>
                                <a class="dropdown-item delete" href="javascript:;" ><i class="la la-leaf"></i> حذف تصنيف </a>
                            </div>
                        </span>`;
                            },
                        },
