        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('catagory.store') }}" method="post">
                        @csrf
...
{{--                            // if the creation for the admin complete successfully--}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg text-left" aria-describedby="emailHelp"
                                       placeholder="اسم التصنيف باللغة العربية" name="name_ar" value="{{ old('name_ar') }}">
                            </div>
                            <div class="form-group">
                                <label>اسم التصنيف باللغة الإنجليزية</label>
                                <input type="text" class="form-control form-control-lg text-left" aria-describedby="emailHelp"
                                       placeholder="اسم التصنيف باللغة الإنجليزية" name="name_en" value="{{ old('name_en') }}">
                            </div>
