        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('mailingNews.send') }}" method="post" id="kt_form_1">
                        @csrf
                        ...
                        <div class="kt-portlet__body ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <textarea class="summernote" id="kt_summernote_1" name="news" style="display: none"></textarea>
                                </div>
                            </div>
