        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('city.update' , $city->id) }}" method="post" id="kt_form_1">
                        @csrf
                        @method('put')
                        ...
                        <div class="kt-portlet__body ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg text-left" aria-describedby="emailHelp"
                                       placeholder="اسم المدينة باللغة العربية" name="name_ar" value="{{ $city->name_ar }}">
                            </div>
                            <div class="form-group">
                                <label>اسم المدينة باللغة الإنجليزية</label>
                                <input type="text" class="form-control form-control-lg text-left" aria-describedby="emailHelp"
                                       placeholder="اسم المدينة باللغة الإنجليزية" name="name_en" value="{{ $city->name_en }}">
                            </div>
