                    ...
                    columnDefs: [
                        ...
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="admin/city/`+ full.id +`/edit"><i class="la la-edit"></i> تعديل بيانات المدينة</a>
                                <a class="dropdown-item delete" href="javascript:;" ><i class="la la-leaf"></i> حذف المدينة </a>
                            </div>
                        </span>`;
                            },
                        },
