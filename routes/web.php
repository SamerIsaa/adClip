...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::post('company/deactivate', 'CompaniesController@deactivate')->name('company.deactivate');
    ...
    Route::resource('admin/company-ad', 'CompanyVideoController')->except(['destroy' ,'create' , 'index']);
    ...
    Route::get('admin/company/{id}/company-ad/create', 'CompanyVideoController@create')->name('company-ad.create');
    ...
    Route::post('company-ad/upload', 'CompanyVideoController@upload')->name('company-ad.upload');
    Route::post('company-ad/delete', 'CompanyVideoController@delete')->name('company-ad.delete');
...
Route::get('clients/{city_id}/{catagory_id}' , 'CompaniesController@siteClients')->name('clients.index');
